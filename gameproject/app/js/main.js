...
function init() {
  ...
  gun1 = new Image();
  gun1.src = "cannonpointleft.jpeg";
  gun1.onload = drawCannon1;
  ...
  gun2 = new Image();
  gun2.src = "cannonpointright.jpeg";
  gun2.onload = drawCannon2;
...
function drawCannon1(event) {
  cannon1 = new createjs.Bitmap(gun1);
  cannon1.x = 200;
  cannon1.y = 530;
...
function drawCannon1(event) {
  cannon2 = new createjs.Bitmap(gun2);
  cannon2.x = 500;
  cannon2.y = 800;
